...
trait FactureListTrait
{
    ...
    public function configureColumns(ListColumnsConfiguration $configuration)
    {
        $configuration
            ...
            ->addColumn('Montant', function(Facture $facture) { return $facture->getMontant() . " Chf."; }, SimpleColumn::class)
            ->addColumn('Payé', function(Facture $facture) { return $facture->getMontantPaye() . " Chf."; }, SimpleColumn::class)
