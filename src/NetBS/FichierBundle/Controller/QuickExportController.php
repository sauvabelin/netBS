...
{
    /**
     * @Route("/etiquettes/groupe/{id}", name="netbs.fichier.etiquettes.groupe")
     * @param $id
    ...
    /**
     * @Route("/liste-rega/groupe/{id}", name="netbs.fichier.liste_rega.groupe")
     * @param $id
     * @return \Symfony\Component\HttpFoundation\RedirectResponse
     * @throws \Doctrine\ORM\ORMException
     * @throws \Doctrine\ORM\OptimisticLockException
    ...
    /**
     * @param $id
     * @Route("/etiquettes/no-chef-groupe/{id}", name="netbs.fichier.etiquettes.no_chef_groupe")
     */
