...
class LayoutManager
{
    ...
    public function __construct(BlockManager $manager, $dispatcher)
    {
    ...
    public function render($layout, $config, $layoutConfig = []) {
        ...
        $this->dispatcher->dispatch(PreRenderLayoutEvent::NAME, new PreRenderLayoutEvent($layout, $config, $params));
