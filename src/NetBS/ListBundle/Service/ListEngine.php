...
class ListEngine
{
    ...
    public function __construct(ListManager $listModelManager, RendererManager $rendererManager, ColumnManager $columnManager, PropertyAccessor $accessor, $dispatcher, Stopwatch $stopwatch)
    {
